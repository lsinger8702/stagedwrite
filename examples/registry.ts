...
console.log("M1 example: see demo:graph for M2 editing. See demo:preflight for M3 draft checks. See demo:execution for executable mode. See demo:storage and demo:durable for persistence.");
