...
**2026-09-16：后续固定图 update 契约已获批准，见 [020](020-update-contract-proposal.md)。本文继续记录已实现的首次创建阶段；其中“本版不做 update”和“至多一个 Run”是当前实现限制，不再是下一阶段目标约束。数据模型见 [021](021-update-data-model.md)。**
